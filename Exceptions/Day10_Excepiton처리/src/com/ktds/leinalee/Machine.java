...
//			배열 안에 "콜라"를 넣어준다. 판매될 경우 "판매중"이라 바꾸면서 체크한다 
	 ...
	 */
	public boolean getMoney (int money, People customer ) {
...
//	각 음료의 수량을 알기위한 getDrinkQuantity overloading**
	private int getDrinkQuantity ( String drinks[], String drinkName) {
		
		int drinkQuantity  = 0;
		
		for ( String drink : drinks ) {
//			판매 중이 아닌 drinks랑 같은 이름을 체크하고 수량을 확인한다 
...
//		saleCount : 음료수를 넘길 때 마다 증가하는 변수 
		int saleCount = 0; 
